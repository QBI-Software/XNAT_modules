...
import org.nrg.xdat.om.Irc5Braindata;
 ...
 * @author XDAT
 */
public class XDATScreen_edit_irc5_brainData extends org.nrg.xnat.turbine.modules.screens.EditSubjectAssessorScreen {
    static org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(XDATScreen_edit_irc5_brainData.class);

    /* (non-Javadoc)
     * @see org.nrg.xdat.turbine.modules.screens.EditScreenA#getElementName()
     */
    public String getElementName() {
        return Irc5Braindata.SCHEMA_ELEMENT_NAME;
    }
    ...
    public void finalProcessing(RunData data, Context context) {
        ...
        try {
            ...
            if (!context.containsKey("label")) {
                ...
                final List<XnatSubjectassessordata> bloodsamples = subject.getExperiments_experiment(Irc5Braindata.SCHEMA_ELEMENT_NAME);
