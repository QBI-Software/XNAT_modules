...
import org.nrg.xdat.om.Irc5Npsdata;
 ...
 *
 */
public class XDATScreen_edit_irc5_npsData extends org.nrg.xnat.turbine.modules.screens.EditSubjectAssessorScreen {
	static org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(XDATScreen_edit_irc5_npsData.class);
	/* (non-Javadoc)
	 * @see org.nrg.xdat.turbine.modules.screens.EditScreenA#getElementName()
	 */
	public String getElementName() {
	    return Irc5Npsdata.SCHEMA_ELEMENT_NAME;
	}
	...
	public void finalProcessing(RunData data, Context context) {
		...
		try {
			...
			if (!context.containsKey("label")) {
				...
				final List<XnatSubjectassessordata> bloodsamples = subject.getExperiments_experiment(Irc5Npsdata.SCHEMA_ELEMENT_NAME);
