...
import org.nrg.xdat.om.Irc5Salivadata;
 ...
 * @author XDAT
 */
public class XDATScreen_edit_irc5_salivaData extends org.nrg.xnat.turbine.modules.screens.EditSubjectAssessorScreen {
    static org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(XDATScreen_edit_irc5_salivaData.class);

    /* (non-Javadoc)
     * @see org.nrg.xdat.turbine.modules.screens.EditScreenA#getElementName()
     */
    public String getElementName() {
        return Irc5Salivadata.SCHEMA_ELEMENT_NAME;
    }
    ...
    public void finalProcessing(RunData data, Context context) {
        ...
        try {
            ...
            if (!context.containsKey("label")) {
                ...
                final List<XnatSubjectassessordata> bloodsamples = subject.getExperiments_experiment(Irc5Salivadata.SCHEMA_ELEMENT_NAME);
